...
{
    public class FormulaValueConverter : AbstractValueConverter<string>
    {
        ...
        public override Dictionary<StandardValueType, StandardValueConversionLoss?> DefaultConversionLoss { get; } =
            new()
            {
                ...
                {StandardValueType.SingleChoice, StandardValueConversionLoss.All},
                {StandardValueType.MultipleChoice, StandardValueConversionLoss.All},
