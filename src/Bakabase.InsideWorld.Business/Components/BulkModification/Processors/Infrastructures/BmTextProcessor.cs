...
namespace Bakabase.InsideWorld.Business.Components.BulkModification.Processors.Infrastructures
{
    ...
    {
        protected override Task ProcessInternal(TextProcessValue value, Bakabase.Abstractions.Models.Domain.Resource resource,
        ...
        protected abstract string? GetValue(Bakabase.Abstractions.Models.Domain.Resource resource, string? propertyKey);
        protected abstract void SetValue(Bakabase.Abstractions.Models.Domain.Resource resource, string? propertyKey, string? value);
    }
}