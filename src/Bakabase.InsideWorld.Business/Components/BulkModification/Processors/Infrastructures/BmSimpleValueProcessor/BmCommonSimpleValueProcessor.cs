...
namespace Bakabase.InsideWorld.Business.Components.BulkModification.Processors.Infrastructures.BmSimpleValueProcessor
{
    ...
    {
        protected abstract void SetValue(Bakabase.Abstractions.Models.Domain.Resource resource, TPropertyType value);
        ...
        protected abstract void RemoveValue(Bakabase.Abstractions.Models.Domain.Resource resource);

        protected override async Task ProcessInternal(BmSimpleValueProcessorValue<string> value, Bakabase.Abstractions.Models.Domain.Resource resource,
