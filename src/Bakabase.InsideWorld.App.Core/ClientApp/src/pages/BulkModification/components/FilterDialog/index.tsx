...
import type { IBulkModificationFilter } from '@/pages/BulkModification';
import {
  filterTargetComponents,
  FilterTargetComponentValueType,
  FindInAliasesProperties,
} from '@/pages/BulkModification/components/FilterDialog/models';
import CustomIcon from '@/components/CustomIcon';
import ResourceCategorySelector from '@/components/ResourceCategorySelector';
import ValueRenderer from '@/pages/BulkModification/components/FilterDialog/components/ValueRenderer';
