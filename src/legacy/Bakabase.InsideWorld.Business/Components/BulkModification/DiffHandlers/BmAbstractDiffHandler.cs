...
namespace Bakabase.InsideWorld.Business.Components.BulkModification.DiffHandlers
{
    public abstract class BmAbstractDiffHandler<TValue> : IBulkModificationDiffHandler
    {
        ...
        protected abstract void SetProperty(Bakabase.Abstractions.Models.Domain.Resource resource, TValue? value, BulkModificationDiff diff);
        public void Apply(Bakabase.Abstractions.Models.Domain.Resource resource, BulkModificationDiff diff) => ApplyOrRevert(resource, diff, true);
        public void Revert(Bakabase.Abstractions.Models.Domain.Resource resource, BulkModificationDiff diff) => ApplyOrRevert(resource, diff, false);
        ...
        protected virtual void ApplyOrRevert(Bakabase.Abstractions.Models.Domain.Resource resource, BulkModificationDiff diff, bool apply)
        {
