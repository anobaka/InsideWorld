...
namespace Bakabase.InsideWorld.Business.Components.BulkModification.Processors.Infrastructures.BmMultipleValueProcessor
{
    ...
    {
        protected abstract List<TProperty>? GetValues(Bakabase.Abstractions.Models.Domain.Resource resource);
        protected abstract void SetValues(Bakabase.Abstractions.Models.Domain.Resource resource, List<TProperty>? values);
        ...
        protected override async Task ProcessInternal(
            ...
            Bakabase.Abstractions.Models.Domain.Resource resource, Dictionary<string, string?> variables,
            string? propertyKey)
        {
