...
{
    public class StringValueHandler : AbstractStandardValueHandler<string>
    {
        ...
        protected override List<string>? ExtractTextsForConvertingToDateTimeInternal(string optimizedValue) =>
            [optimizedValue];
